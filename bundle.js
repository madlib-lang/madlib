(function (global, factory) {
  ...
  var Function = { complement, always, identity, equals, notEquals, ifElse, when, not, noop, flip, any, all, either, both, memoize };

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Functor.mad

  window.Functor = {};
  let mapL = (Functor_l11) => (_P_ => Functor_l11.map()(always(_P_)));

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Applicative.mad
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Show.mad
  window.Show = {};
  ...
  let gt = (Comparable_s44) => (a => b => __eq__(Comparable_s44.compare()(a)(b), MORE));

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Scan.mad

  window.Scan = {};

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Number.mad
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Semigroup.mad
  window.Semigroup = {};

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Monoid.mad
  ...
  let mapM$1 = (Functor_g214) => (Applicative_g214) => (f => list => {
  ...
  let intersperseWithIndex = (f => list => {
      let go = (i => xs => ((__x__) => {
    if (__x__ === null) {
      return (null);
    }
  ...
  let reduceM = (Functor_c548) => (Applicative_c548) => (Monad_c548) => (f => acc => list => ((__x__) => {
    if (__x__ === null) {
      return Monad_c548.of()(acc);
    }
    else if (__x__ !== null && true && true) {
      let { v: a, n: xs } = __x__;
      return Monad_c548.chain()((v => reduceM()(Applicative_c548)(Monad_c548)(f)(v)(xs)))(f(acc)(a));
    }
    else {
      console.log('non exhaustive patterns for value: ', __x__.toString()); 
      console.trace(); 
  ...
  let reject = (predicate => list => filter(Function.complement(predicate))(list));
  ...
  let sort = (Comparable_k1024) => sortBy(Comparable_k1024.compare());
  let sortAsc = (Comparable_n1027) => sort(Comparable_n1027);
  let sortDesc = (Comparable_t1033) => sortBy((a => b => (Comparable_t1033.compare()(a)(b) * -1)));
  let flatten = (list => {
      let $_result_;
      let $_continue_ = true;
      let $_start_ = {};
  ...
  let contains$1 = (needle => haystack => Function.any(startsWith$1(needle))(tails(haystack)));
  ...
  let endsWith$1 = (subset => list => ((__x__) => {
    if (__x__.__constructor === "Just" && true) {
  ...
  var List = { mapMaybe, repeat: repeat$1, repeatWith, range, mapM: mapM$1, singleton, intercalate, intersperse, intersperseWithIndex, mapWithIndex, concat, append, last, first, init: init$1, tail, nth, reduceRight, reduceLeft, reduce, reduceM, filter, reject, find, _$_length_$_: _$_length_$_$2, slice: slice$1, isEmpty: isEmpty$1, uniqueBy, sortBy, sort, sortAsc, sortDesc, flatten, zip, includes: includes$1, drop: drop$1, dropLast: dropLast$1, take: take$1, takeLast: takeLast$1, dropWhile: dropWhile$1, takeWhile: takeWhile$2, reverse: reverse$1, tails, startsWith: startsWith$1, contains: contains$1, endsWith: endsWith$1 };
  ...
  let fromList$2 = (Comparable_m90) => (_P_ => Dictionary(removeConsecutiveDoubles(List.sortBy((a => b => Comparable_m90.compare()(Tuple.fst(a))(Tuple.fst(b))))(_P_))));
  let empty$1 = Dictionary((null));
  let insert = (Comparable_w152) => (key => value => dict => {
      let helper = (list => {
      let $_result_;
      let $_continue_ = true;
      let $_start_ = {};
  ...
  let update = (Comparable_d211) => (fn => key => dict => {
      let helper = (list => {
      let $_result_;
      let $_continue_ = true;
      let $_start_ = {};
  ...
  let get = (Comparable_s226) => (k => __x__ => ((__x__) => {
    if (__x__.__constructor === "Dictionary" && true) {
      let items = __x__.__args[0];
  ...
  let merge = (Comparable_c262) => (a => b => ((__x__) => {
    if (__x__.length === 2 && __x__[0].__constructor === "Dictionary" && true && __x__[1].__constructor === "Dictionary" && true) {
      ...
      return fromList$2(Comparable_c262)(List.concat(itemsA)(itemsB));
    }
    else {
      console.log('non exhaustive patterns for value: ', __x__.toString()); 
      console.trace(); 
  ...
  let _$_length_$_$1 = (dictionary => ((__x__) => {
    if (__x__.__constructor === "Dictionary" && true) {
      let items = __x__.__args[0];
  ...
  let mapM = (Functor_p327) => (Applicative_p327) => (f => dict => ((__x__) => {
    if (__x__.__constructor === "Dictionary" && true) {
      let items = __x__.__args[0];
  ...
  var Dictionary$1 = { fromList: fromList$2, empty: empty$1, insert, update, get, merge, _$_length_$_: _$_length_$_$1, toList: toList$1, mapM, mapWithKey, keys, values };

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Bifunctor.mad
  window.Bifunctor = {};
  ...
  let syncAction = (stateUpdate => _ => event => ({ v: Monad.Wish_a42e274f9391b247f6eb25b247963687.of()((state => stateUpdate(state)(event))), n: null }));
  ...
  Inspect['Record_globalEventHandlersf_0e264b6be2a515e01e171e67e9c05fdef_subscriptionsf_1e264b6be2a515e01e171e67e9c05fdef']['inspect'] = () => (Inspect_t71) => (Inspect_m64) => (__$a__ => `{ ` + `globalEventHandlers: ` + Inspect_m64.inspect()(__$a__.globalEventHandlers) + `, ` + `subscriptions: ` + Inspect_t71.inspect()(__$a__.subscriptions) + ` }`);
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/ByteArray.mad
  let fromList$1 = (bytes =>  {
    let bytesArray = [];
    while (bytes !== null) {
  ...
  let filterChars = (predicate => s => (_P_ => fromList(List.filter(predicate)(toList(_P_))))(s));
  let reduceChars = (f => initial => s => (_P_ => List.reduce(f)(initial)(toList(_P_)))(s));
  ...
  let dropWhile = (predicate => s => (_P_ => fromList(List.dropWhile(predicate)(toList(_P_))))(s));
  let take = (n => s => slice(0)(n)(s));
  let takeLast = (n => s => slice(-n)(0)(s));
  let takeWhile$1 = (predicate => s => (_P_ => fromList(List.takeWhile(predicate)(toList(_P_))))(s));
  let charAt = (n => s => {
    const c = s[n];
    return !!c ? Just(c) : Nothing
  });
  let firstChar = charAt(0);
  let lastChar = (s => charAt((_$_length_$_(s) - 1))(s));
  let trim = (s =>  s.trim() );
  let trimStart = (s =>  s.trimStart() );
  let trimEnd = (s =>  s.trimEnd() );
  let _$_length_$_ = (s =>  s.length );
  let repeat = (c => n => (_P_ => fromList(List.repeat(c)(_P_)))(n));
  ...
  let reverse = (s => (_P_ => fromList(List.reverse(toList(_P_))))(s));
  let includes = (c => s => (_P_ => List.includes(c)(toList(_P_)))(s));
  let startsWith = (subset => s => (_P_ => List.startsWith(toList(subset))(toList(_P_)))(s));
  let contains = (subset => s => (_P_ => List.contains(toList(subset))(toList(_P_)))(s));
  let endsWith = (subset => s => (_P_ => List.endsWith(toList(subset))(toList(_P_)))(s));
  var String$1 = { toLower: toLower$1, toUpper: toUpper$1, split, join, lines, unlines, words, unwords, toList, fromList, mapChars, filterChars, reduceChars, slice, isEmpty, drop, dropLast, dropWhile, take, takeLast, takeWhile: takeWhile$1, charAt, firstChar, lastChar, trim, trimStart, trimEnd, _$_length_$_, repeat, match, replace, pushChar, appendChar, reverse, includes, startsWith, contains, endsWith };

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Http.mad
  Inspect['Header_f17c8605a23705315ad6ec8e76ea07f7'] = {};
  Inspect['Header_f17c8605a23705315ad6ec8e76ea07f7']['inspect'] = () => (__$a__ => ((__x__) => {
  ...
  Inspect['Method_f17c8605a23705315ad6ec8e76ea07f7'] = {};
  Inspect['Method_f17c8605a23705315ad6ec8e76ea07f7']['inspect'] = () => (__$a__ => ((__x__) => {
  ...
  Inspect['Record_bodyf_0f17c8605a23705315ad6ec8e76ea07f7_headersf_1f17c8605a23705315ad6ec8e76ea07f7_statusf_2f17c8605a23705315ad6ec8e76ea07f7'] = {};
  Inspect['Record_bodyf_0f17c8605a23705315ad6ec8e76ea07f7_headersf_1f17c8605a23705315ad6ec8e76ea07f7_statusf_2f17c8605a23705315ad6ec8e76ea07f7']['inspect'] = () => (Inspect_w438) => (Inspect_p431) => (Inspect_i424) => (__$a__ => `{ ` + `body: ` + Inspect_i424.inspect()(__$a__.body) + `, ` + `headers: ` + Inspect_p431.inspect()(__$a__.headers) + `, ` + `status: ` + Inspect_w438.inspect()(__$a__.status) + ` }`);
  Inspect['ClientError_f17c8605a23705315ad6ec8e76ea07f7'] = {};
  Inspect['ClientError_f17c8605a23705315ad6ec8e76ea07f7']['inspect'] = () => (__$a__ => ((__x__) => {
  ...
  Inspect['Error_f17c8605a23705315ad6ec8e76ea07f7'] = {};
  Inspect['Error_f17c8605a23705315ad6ec8e76ea07f7']['inspect'] = () => (Inspect_g474) => (__$a__ => ((__x__) => {
    if (__x__.__constructor === "BadResponse" && true) {
      let a0 = __x__.__args[0];
      return `BadResponse(` + Inspect.Record_bodyf_0f17c8605a23705315ad6ec8e76ea07f7_headersf_1f17c8605a23705315ad6ec8e76ea07f7_statusf_2f17c8605a23705315ad6ec8e76ea07f7.inspect()(Inspect.Integer_5b7ebeeaa5acfe1eeea5a9e9845b152d)(__apMtdDicts__(Inspect.List_5b7ebeeaa5acfe1eeea5a9e9845b152d, [Inspect.Header_f17c8605a23705315ad6ec8e76ea07f7]))(Inspect_g474)(a0) + `)`;
    }
    else if (__x__.__constructor === "ClientError" && true) {
      let a0 = __x__.__args[0];
      return `ClientError(` + Inspect.ClientError_f17c8605a23705315ad6ec8e76ea07f7.inspect()(a0) + `)`;
    }
    else {
      return `Unknown`;
    }
  })(__$a__));
  Inspect['Record_bodyf_0f17c8605a23705315ad6ec8e76ea07f7_headersf_1f17c8605a23705315ad6ec8e76ea07f7_methodf_2f17c8605a23705315ad6ec8e76ea07f7_urlf_3f17c8605a23705315ad6ec8e76ea07f7'] = {};
  Inspect['Record_bodyf_0f17c8605a23705315ad6ec8e76ea07f7_headersf_1f17c8605a23705315ad6ec8e76ea07f7_methodf_2f17c8605a23705315ad6ec8e76ea07f7_urlf_3f17c8605a23705315ad6ec8e76ea07f7']['inspect'] = () => (Inspect_u514) => (Inspect_n507) => (Inspect_g500) => (Inspect_z493) => (__$a__ => `{ ` + `body: ` + Inspect_z493.inspect()(__$a__.body) + `, ` + `headers: ` + Inspect_g500.inspect()(__$a__.headers) + `, ` + `method: ` + Inspect_n507.inspect()(__$a__.method) + `, ` + `url: ` + Inspect_u514.inspect()(__$a__.url) + ` }`);
  ...
  Functor.Either_651c79f49e941df22f23aa6ad4c094c2.map();
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/JsonValue.mad
  ...
  Inspect['JsonValue_0a7c5bddb410b17ee2c362c6c5d4bbee'] = {};
  Inspect['JsonValue_0a7c5bddb410b17ee2c362c6c5d4bbee']['inspect'] = () => (__$a__ => ((__x__) => {
    if (__x__.__constructor === "JsonString" && true) {
      ...
      let a0 = __x__.__args[0];
      return `JsonObject(` + Inspect.Dictionary_5b7ebeeaa5acfe1eeea5a9e9845b152d.inspect()(Inspect.JsonValue_0a7c5bddb410b17ee2c362c6c5d4bbee)(Inspect.String_5b7ebeeaa5acfe1eeea5a9e9845b152d)(a0) + `)`;
    }
    else if (__x__.__constructor === "JsonArray" && true) {
      let a0 = __x__.__args[0];
      return `JsonArray(` + Inspect.List_5b7ebeeaa5acfe1eeea5a9e9845b152d.inspect()(Inspect.JsonValue_0a7c5bddb410b17ee2c362c6c5d4bbee)(a0) + `)`;
    }
    else {
      return `Unknown`;
    }
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Alternative.mad

  window.Alternative = {};

  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Char.mad
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Control.mad
  ...
  Functor['Parser_a352900caef3bd40a91696b29588b516']['map'] = () => (f => m => Parser$1((s => l => ((__x__) => {
  ...
  Applicative['Parser_a352900caef3bd40a91696b29588b516']['ap'] = () => (parserA => parserB => Parser$1((s => l => ((__x__) => {
    if (__x__.length === 2 && __x__[0] === null && true) {
      let [,l1] = __x__;
      return ([(null), l1]);
    }
  ...
  Applicative['Parser_a352900caef3bd40a91696b29588b516']['pure'] = () => (a => Parser$1((s => l => ([({ v: ([a, s]), n: null }), l]))));
  Monad['Parser_a352900caef3bd40a91696b29588b516'] = {};
  Monad['Parser_a352900caef3bd40a91696b29588b516']['chain'] = () => (f => m => Parser$1((s => l => ((__x__) => {
    if (__x__.length === 2 && __x__[0] === null && true) {
      let [,ll] = __x__;
      return ([(null), ll]);
    }
  ...
  Alternative['Parser_a352900caef3bd40a91696b29588b516']['aempty'] = () => Parser$1((_ => l => ([(null), l])));
  Alternative['Parser_a352900caef3bd40a91696b29588b516']['alt'] = () => (ma => mb => Parser$1((s => l => ((__x__) => {
    if (__x__.length === 2 && __x__[0] === null && true) {
  ...
  let fail$1 = Alternative.Parser_a352900caef3bd40a91696b29588b516.aempty();
  ...
  let choice = (ps => List.reduce(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt())(fail$1)(ps));
  ...
  let some = (p => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((first => Functor.Parser_a352900caef3bd40a91696b29588b516.map()((rest => ({ v: first, n: rest })))(many(p))))(p));
  ...
  let someTill = (p => end => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((first => Functor.Parser_a352900caef3bd40a91696b29588b516.map()((rest => Monoid.List_5b7ebeeaa5acfe1eeea5a9e9845b152d.mconcat()(({ v: first, n: null }))(rest)))(manyTill(p)(end))))(p));
  ...
  let sepBy = (parser => separator => Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()((() => {
  ...
  let satisfy = (pred => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()(ifElse(pred)(Monad.Parser_a352900caef3bd40a91696b29588b516.of())(always(fail$1)))(anyChar));
  ...
  let string$1 = (s => ((__x__) => {
    if (__x__.__constructor === "Just" && true) {
      let c = __x__.__args[0];
      return (_P_ => (__$PH3__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH3__)(string$1(String$1.drop(1)(s))))(Functor.Parser_a352900caef3bd40a91696b29588b516.map()((a => b => String$1.pushChar(a)(b)))(_P_)))(char(c));
    }
    else if (__x__.__constructor === "Nothing") {
  ...
  let token = (__$PH4__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH4__)(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(spaces)(Applicative.Parser_a352900caef3bd40a91696b29588b516.pure()((null)))));
  ...
  let stringCharacter = choice(({ v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(__String.fromCharCode(34)))(P.string(`\\\"`)), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(__String.fromCharCode(10)))(P.string(`\\n`)), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(__String.fromCharCode(9)))(P.string(`\\t`)), n: { v: notChar(__String.fromCharCode(34)), n: null } } } }));
  let jsonString = (() => {
    
    return Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((cs => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => (_P_ => Monad.Parser_a352900caef3bd40a91696b29588b516.of()(JsonString(String$1.fromList(_P_))))(cs)))(symbol(`"`))))(many(stringCharacter))))(char(__String.fromCharCode(34)))
  })();
  ...
  let objectField = (() => {
    ...
    return Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((fieldName => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((fieldValue => Monad.Parser_a352900caef3bd40a91696b29588b516.of()(([String$1.fromList(fieldName), fieldValue]))))(jsonValue)))(symbol(`:`))))(char(__String.fromCharCode(34)))))(many(notChar(__String.fromCharCode(34))))))(char(__String.fromCharCode(34)))
  })();
  let jsonObject = (() => {
    
    return Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((fields => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((_ => Monad.Parser_a352900caef3bd40a91696b29588b516.of()(JsonObject(Dictionary$1.fromList(Comparable.String_5b7ebeeaa5acfe1eeea5a9e9845b152d)(fields)))))(symbol(`}`))))(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(spaces)(Applicative.Parser_a352900caef3bd40a91696b29588b516.pure()((null))))))(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(sepBy(objectField)(symbol(`,`)))(Monad.Parser_a352900caef3bd40a91696b29588b516.of()((null))))))(symbol(`{`))
  })();
  let jsonValue = (() => {
  ...
  let dict = (parser => Parser((input => ((__x__) => {
    if (__x__.length === 2 && __x__[0].__constructor === "JsonObject" && true && __x__[1].__constructor === "Parser" && true) {
      ...
      return Dictionary$1.mapM(Functor.Either_651c79f49e941df22f23aa6ad4c094c2)(Applicative.Either_651c79f49e941df22f23aa6ad4c094c2)(parserFn)(d);
    }
    else {
  ...
  let path = (pathParts => parser => Parser((input => (_P_ => Monad.Either_651c79f49e941df22f23aa6ad4c094c2.chain()(getParserFn(parser))(List.reduce((val => fieldName => ((__x__) => {
  ...
  let chain1 = Monad.Parser_ac8d82a07f0a1934824de5402de83a46.chain();
  ...
  let map1 = Functor.Parser_ac8d82a07f0a1934824de5402de83a46.map();
  ...
  var Json = { jsonValue, parse, succeed, fail, string, integer, float, boolean, list, dict, maybe, lazy, field, path, chain1, chain2, chain3, chain4, chain5, chain6, chain7, chain8, map1, map2, map3, map4, map5, map6, map7, map8, Parser };
  ...
  Inspect['Record_constraintsf_0059980c9d93cf2de3fe268b3d9d26775_declarationf_1059980c9d93cf2de3fe268b3d9d26775_descriptionf_2059980c9d93cf2de3fe268b3d9d26775_examplef_3059980c9d93cf2de3fe268b3d9d26775_sincef_4059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_h995) => (Inspect_a988) => (Inspect_t981) => (Inspect_m974) => (Inspect_f967) => (__$a__ => `{ ` + `constraints: ` + Inspect_f967.inspect()(__$a__.constraints) + `, ` + `declaration: ` + Inspect_m974.inspect()(__$a__.declaration) + `, ` + `description: ` + Inspect_t981.inspect()(__$a__.description) + `, ` + `example: ` + Inspect_a988.inspect()(__$a__.example) + `, ` + `since: ` + Inspect_h995.inspect()(__$a__.since) + ` }`);
  ...
  Inspect['Record_constraintsf_0059980c9d93cf2de3fe268b3d9d26775_descriptionf_1059980c9d93cf2de3fe268b3d9d26775_examplef_2059980c9d93cf2de3fe268b3d9d26775_methodsf_3059980c9d93cf2de3fe268b3d9d26775_namef_4059980c9d93cf2de3fe268b3d9d26775_sincef_5059980c9d93cf2de3fe268b3d9d26775_varsf_6059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_l1051) => (Inspect_e1044) => (Inspect_x1037) => (Inspect_q1030) => (Inspect_j1023) => (Inspect_c1016) => (Inspect_v1009) => (__$a__ => `{ ` + `constraints: ` + Inspect_v1009.inspect()(__$a__.constraints) + `, ` + `description: ` + Inspect_c1016.inspect()(__$a__.description) + `, ` + `example: ` + Inspect_j1023.inspect()(__$a__.example) + `, ` + `methods: ` + Inspect_q1030.inspect()(__$a__.methods) + `, ` + `name: ` + Inspect_x1037.inspect()(__$a__.name) + `, ` + `since: ` + Inspect_e1044.inspect()(__$a__.since) + `, ` + `vars: ` + Inspect_l1051.inspect()(__$a__.vars) + ` }`);
  ...
  Inspect['Record_aliasedTypef_0059980c9d93cf2de3fe268b3d9d26775_descriptionf_1059980c9d93cf2de3fe268b3d9d26775_examplef_2059980c9d93cf2de3fe268b3d9d26775_namef_3059980c9d93cf2de3fe268b3d9d26775_paramsf_4059980c9d93cf2de3fe268b3d9d26775_sincef_5059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_k1102) => (Inspect_d1095) => (Inspect_w1088) => (Inspect_p1081) => (Inspect_i1074) => (Inspect_b1067) => (__$a__ => `{ ` + `aliasedType: ` + Inspect_b1067.inspect()(__$a__.aliasedType) + `, ` + `description: ` + Inspect_i1074.inspect()(__$a__.description) + `, ` + `example: ` + Inspect_p1081.inspect()(__$a__.example) + `, ` + `name: ` + Inspect_w1088.inspect()(__$a__.name) + `, ` + `params: ` + Inspect_d1095.inspect()(__$a__.params) + `, ` + `since: ` + Inspect_k1102.inspect()(__$a__.since) + ` }`);
  ...
  Inspect['Record_constructorsf_0059980c9d93cf2de3fe268b3d9d26775_descriptionf_1059980c9d93cf2de3fe268b3d9d26775_examplef_2059980c9d93cf2de3fe268b3d9d26775_namef_3059980c9d93cf2de3fe268b3d9d26775_paramsf_4059980c9d93cf2de3fe268b3d9d26775_sincef_5059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_i1152) => (Inspect_b1145) => (Inspect_u1138) => (Inspect_n1131) => (Inspect_g1124) => (Inspect_z1117) => (__$a__ => `{ ` + `constructors: ` + Inspect_z1117.inspect()(__$a__.constructors) + `, ` + `description: ` + Inspect_g1124.inspect()(__$a__.description) + `, ` + `example: ` + Inspect_n1131.inspect()(__$a__.example) + `, ` + `name: ` + Inspect_u1138.inspect()(__$a__.name) + `, ` + `params: ` + Inspect_b1145.inspect()(__$a__.params) + `, ` + `since: ` + Inspect_i1152.inspect()(__$a__.since) + ` }`);
  ...
  Inspect['Record_descriptionf_0059980c9d93cf2de3fe268b3d9d26775_examplef_1059980c9d93cf2de3fe268b3d9d26775_namef_2059980c9d93cf2de3fe268b3d9d26775_sincef_3059980c9d93cf2de3fe268b3d9d26775_typingf_4059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_z1195) => (Inspect_s1188) => (Inspect_l1181) => (Inspect_e1174) => (Inspect_x1167) => (__$a__ => `{ ` + `description: ` + Inspect_x1167.inspect()(__$a__.description) + `, ` + `example: ` + Inspect_e1174.inspect()(__$a__.example) + `, ` + `name: ` + Inspect_l1181.inspect()(__$a__.name) + `, ` + `since: ` + Inspect_s1188.inspect()(__$a__.since) + `, ` + `typing: ` + Inspect_z1195.inspect()(__$a__.typing) + ` }`);
  Inspect['Targeted_059980c9d93cf2de3fe268b3d9d26775'] = {};
  Inspect['Targeted_059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_l1207) => (__$a__ => ((__x__) => {
    if (__x__.__constructor === "BothTargets" && true && true) {
      let a0 = __x__.__args[0];
      let a1 = __x__.__args[1];
      return `BothTargets(` + Inspect_l1207.inspect()(a0) + `, ` + Inspect_l1207.inspect()(a1) + `)`;
    }
    else if (__x__.__constructor === "JSTarget" && true) {
      let a0 = __x__.__args[0];
      return `JSTarget(` + Inspect_l1207.inspect()(a0) + `)`;
    }
    else if (__x__.__constructor === "LLVMTarget" && true) {
      let a0 = __x__.__args[0];
      return `LLVMTarget(` + Inspect_l1207.inspect()(a0) + `)`;
    }
    else {
      return `Unknown`;
    }
  ...
  Inspect['Record_aliasesf_0059980c9d93cf2de3fe268b3d9d26775_descriptionf_1059980c9d93cf2de3fe268b3d9d26775_expressionsf_2059980c9d93cf2de3fe268b3d9d26775_instancesf_3059980c9d93cf2de3fe268b3d9d26775_interfacesf_4059980c9d93cf2de3fe268b3d9d26775_namef_5059980c9d93cf2de3fe268b3d9d26775_pathf_6059980c9d93cf2de3fe268b3d9d26775_typeDeclarationsf_7059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_h1281) => (Inspect_a1274) => (Inspect_t1267) => (Inspect_m1260) => (Inspect_f1253) => (Inspect_y1246) => (Inspect_r1239) => (Inspect_k1232) => (__$a__ => `{ ` + `aliases: ` + Inspect_k1232.inspect()(__$a__.aliases) + `, ` + `description: ` + Inspect_r1239.inspect()(__$a__.description) + `, ` + `expressions: ` + Inspect_y1246.inspect()(__$a__.expressions) + `, ` + `instances: ` + Inspect_f1253.inspect()(__$a__.instances) + `, ` + `interfaces: ` + Inspect_m1260.inspect()(__$a__.interfaces) + `, ` + `name: ` + Inspect_t1267.inspect()(__$a__.name) + `, ` + `path: ` + Inspect_a1274.inspect()(__$a__.path) + `, ` + `typeDeclarations: ` + Inspect_h1281.inspect()(__$a__.typeDeclarations) + ` }`);
  Inspect['Record_namef_0059980c9d93cf2de3fe268b3d9d26775'] = {};
  Inspect['Record_namef_0059980c9d93cf2de3fe268b3d9d26775']['inspect'] = () => (Inspect_y1298) => (__$a__ => `{ ` + `name: ` + Inspect_y1298.inspect()(__$a__.name) + ` }`);
  ...
  // file: /opt/hostedtoolcache/node/14.21.1/x64/lib/node_modules/@madlib-lang/madlib/node_modules/binary-install/node_modules/.bin/prelude/__internal__/Url.mad
  ...
  Inspect['Record_hasJSf_0fb2405d57728f715cc9132d779e7fbdd_hasLLVMf_1fb2405d57728f715cc9132d779e7fbdd_isAvailablef_2fb2405d57728f715cc9132d779e7fbdd']['inspect'] = () => (Inspect_l63) => (Inspect_e56) => (Inspect_x49) => (__$a__ => `{ ` + `hasJS: ` + Inspect_x49.inspect()(__$a__.hasJS) + `, ` + `hasLLVM: ` + Inspect_e56.inspect()(__$a__.hasLLVM) + `, ` + `isAvailable: ` + Inspect_l63.inspect()(__$a__.isAvailable) + ` }`);
  ...
  let between = (start => mid => end => (_P_ => (__$PH2__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH2__)(end))((__$PH1__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH1__)(mid))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(identity)(_P_))))(start));
  ...
  let bold = (_P_ => (__$PH4__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH4__)(P.string(`**`)))((__$PH3__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH3__)((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)((a => P.someTill(a)(P.lookAhead(P.string(`**`))))(_P_)))(P.notChar(__String.fromCharCode(10)))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Bold)(_P_))))(P.string(`**`));
  let italic = (_P_ => (__$PH7__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH7__)(P.char(__String.fromCharCode(42))))((__$PH6__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH6__)((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.many(_P_)))(P.notOneOf(({ v: __String.fromCharCode(42), n: { v: __String.fromCharCode(10), n: null } })))))((__$PH5__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH5__)(P.notChar(__String.fromCharCode(32))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)((a => b => Italic(String$1.pushChar(a)(b))))(_P_)))))(P.char(__String.fromCharCode(42)));
  let inlineCode = (_P_ => (__$PH9__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH9__)(P.char(__String.fromCharCode(96))))((__$PH8__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH8__)((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.many(_P_)))(P.notOneOf(({ v: __String.fromCharCode(96), n: { v: __String.fromCharCode(10), n: null } })))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(InlineCode)(_P_))))(P.char(__String.fromCharCode(96)));
  let link = (_P_ => (__$PH10__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH10__)(between(P.char(__String.fromCharCode(40)))((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.many(_P_)))(linkCharacter))(P.char(__String.fromCharCode(41)))))(Functor.Parser_a352900caef3bd40a91696b29588b516.map()(Link)(_P_)))(between(P.char(__String.fromCharCode(91)))((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.many(_P_)))(P.notOneOf(({ v: __String.fromCharCode(93), n: { v: __String.fromCharCode(10), n: null } }))))(P.char(__String.fromCharCode(93))));
  let image = (_P_ => (__$PH12__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH12__)(between(P.char(__String.fromCharCode(40)))((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.many(_P_)))(linkCharacter))(P.char(__String.fromCharCode(41)))))((__$PH11__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH11__)(between(P.char(__String.fromCharCode(91)))((_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.many(_P_)))(P.notOneOf(({ v: __String.fromCharCode(93), n: { v: __String.fromCharCode(10), n: null } }))))(P.char(__String.fromCharCode(93)))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Image)(_P_))))(P.char(__String.fromCharCode(33)));
  let textTerminals = P.choice(({ v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(bold), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(italic), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(inlineCode), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(image), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(link), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(P.eof), n: { v: P.string(`\n`), n: null } } } } } } }));
  let text = (_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()((_P_ => Text(String$1.fromList(_P_))))((__$PH13__ => P.someTill(__$PH13__)(P.lookAhead(textTerminals)))(_P_)))(P.notChar(__String.fromCharCode(10)));
  let lineReturn = Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(LineReturn))(P.char(__String.fromCharCode(10)));
  let content = (_P_ => P.many(P.choice(_P_)))(({ v: bold, n: { v: italic, n: { v: inlineCode, n: { v: image, n: { v: link, n: { v: text, n: null } } } } } }));
  let lineReturnExceptBefore = (before => (_P_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()((__x__ => ((__x__) => {
    if (__x__.__constructor === "Just" && true) {
      return Alternative.Parser_a352900caef3bd40a91696b29588b516.aempty();
    }
    else if (__x__.__constructor === "Nothing") {
      return lineReturn;
    }
  ...
  })(__x__)))(P.lookAhead((__$PH14__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH14__)(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(Just(({ __constructor: "Unit", __args: [] }))))(before))(Applicative.Parser_a352900caef3bd40a91696b29588b516.pure()(Nothing))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(identity)(_P_)))))(lineReturn));
  let contentWithLineReturn = (delimiter => (_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(dropWhile$1(equals(LineReturn)))(P.some(P.choice(_P_))))(({ v: bold, n: { v: italic, n: { v: inlineCode, n: { v: image, n: { v: link, n: { v: text, n: { v: lineReturnExceptBefore(delimiter), n: null } } } } } } })));
  let heading = (constructor => _P_ => (__$PH16__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH16__)(singleReturnTerminal))((__$PH15__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH15__)(content))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(constructor)(P.symbol(_P_)))));
  let singleReturnTerminal = Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(P.string(`\n`))(Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(P.eof));
  let doubleReturnTerminal = P.choice(({ v: P.string(`\n\n`), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(P.eof), n: { v: (_P_ => (__$PH17__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH17__)(P.eof))(Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(Applicative.Parser_a352900caef3bd40a91696b29588b516.pure()((_ => _ => ``)))(_P_)))(P.char(__String.fromCharCode(10))), n: null } } }));
  let code = (_P_ => (__$PH21__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH21__)(P.choice(({ v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()((_ => ``))(apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(P.string(`\n\`\`\``))(P.eof)), n: { v: P.string(`\n\`\`\`\n`), n: null } }))))((__$PH20__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH20__)(Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.manyTill(P.anyChar)(P.lookAhead(P.string(`\n\`\`\``))))))((__$PH19__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH19__)(P.char(__String.fromCharCode(10))))((__$PH18__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH18__)(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(Functor.Parser_a352900caef3bd40a91696b29588b516.map()(String$1.fromList)(P.letters))(Applicative.Parser_a352900caef3bd40a91696b29588b516.pure()(``))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)((lang => c => Code(lang)(c)))(_P_))))))(P.string(`\`\`\``));
  let blockquote = (_P_ => (__$PH23__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH23__)(P.choice(({ v: doubleReturnTerminal, n: { v: P.lookAhead(P.string(`\n\`\`\``)), n: { v: P.lookAhead(P.string(`\n>`)), n: null } } }))))((__$PH22__ => Applicative.Parser_a352900caef3bd40a91696b29588b516.ap()(__$PH22__)(contentWithLineReturn(P.choice(({ v: P.string(`\n`), n: { v: P.string(`\`\`\``), n: { v: P.string(`>`), n: null } } })))))(mapL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Blockquote)(_P_))))(Alternative.Parser_a352900caef3bd40a91696b29588b516.alt()(P.symbol(`>`))(P.string(`>`)));
  let listItemStart = Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(``))(apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(P.many(P.char(__String.fromCharCode(32))))(apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(P.oneOf(({ v: __String.fromCharCode(42), n: { v: __String.fromCharCode(45), n: { v: __String.fromCharCode(43), n: null } } })))(P.some(P.char(__String.fromCharCode(32))))));
  let unorderedListItem = (_P_ => Monad.Parser_a352900caef3bd40a91696b29588b516.chain()(always(apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(content)(singleReturnTerminal)))(_P_))(listItemStart);
  let unorderedList = (_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()(UnorderedList)(P.some(_P_)))(unorderedListItem);
  let paragraph = (_P_ => (__$PH24__ => apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(__$PH24__)(P.choice(({ v: doubleReturnTerminal, n: { v: P.lookAhead(P.string(`\n\`\`\``)), n: { v: P.lookAhead(P.string(`\n>`)), n: { v: P.lookAhead(apL(Functor.Parser_a352900caef3bd40a91696b29588b516)(Applicative.Parser_a352900caef3bd40a91696b29588b516)(P.string(`\n`))(listItemStart)), n: null } } } }))))(Functor.Parser_a352900caef3bd40a91696b29588b516.map()(Paragraph)(_P_)))(contentWithLineReturn(P.choice(({ v: listItemStart, n: { v: P.string(`\n`), n: { v: P.string(`\`\`\``), n: { v: P.string(`>`), n: null } } } }))));
  ...
  let markdownParser = (_P_ => Functor.Parser_a352900caef3bd40a91696b29588b516.map()((_P_ => Functor.List_5b7ebeeaa5acfe1eeea5a9e9845b152d.map()((__x__ => ((__x__) => {
    if (__x__.__constructor === "Just" && true) {
      let x = __x__.__args[0];
      return x;
    }
  ...
  })(__x__)))(_P_))))(P.many(P.choice(_P_))))(({ v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(always(Nothing))(P.spaces), n: { v: Functor.Parser_a352900caef3bd40a91696b29588b516.map()(Just)(block), n: null } }));
  ...
  Inspect['Record_typingf_012b3f388bf3fa7bc5de893603b272d66'] = {};
  Inspect['Record_typingf_012b3f388bf3fa7bc5de893603b272d66']['inspect'] = () => (Inspect_s44) => (__$a__ => `{ ` + `typing: ` + Inspect_s44.inspect()(__$a__.typing) + ` }`);
  ...
  let handleInput = (state => event => ((__x__) => {
    if (__x__.__constructor === "InputEvent" && true) {
      let e = __x__.__args[0];
      return ({ v: Monad.Wish_a42e274f9391b247f6eb25b247963687.of()(always(({ ...state, search: String$1.toLower(e.target.value) }))), n: null });
    }
    else {
      console.log('non exhaustive patterns for value: ', __x__.toString()); 
      console.trace(); 
  ...
  let Breadcrumbs = (_P_ => (breadcrumbs => ul(({ v: className(`breadcrumbs`), n: null }))((breadcrumbs)))(intersperseWithIndex((i => li(({ v: className(`breadcrumbs__separator`), n: { v: key(`sep-` + Show.Integer_5b7ebeeaa5acfe1eeea5a9e9845b152d.show()(i)), n: null } }))(({ v: `/`, n: null }))))(Functor.List_5b7ebeeaa5acfe1eeea5a9e9845b152d.map()(BreadcrumbItem)(computeBreadcrumbs(_P_)))));
  ...
  Inspect['Record_hasJSf_08676e862654b892c9c43f99085b0b684_hasLLVMf_18676e862654b892c9c43f99085b0b684_isAvailablef_28676e862654b892c9c43f99085b0b684']['inspect'] = () => (Inspect_u254) => (Inspect_n247) => (Inspect_g240) => (__$a__ => `{ ` + `hasJS: ` + Inspect_g240.inspect()(__$a__.hasJS) + `, ` + `hasLLVM: ` + Inspect_n247.inspect()(__$a__.hasLLVM) + `, ` + `isAvailable: ` + Inspect_u254.inspect()(__$a__.isAvailable) + ` }`);
  ...
  Inspect['Record_hasJSf_0282beae8e01da97cf064d349e642ce84_hasLLVMf_1282beae8e01da97cf064d349e642ce84_isAvailablef_2282beae8e01da97cf064d349e642ce84']['inspect'] = () => (Inspect_n169) => (Inspect_g162) => (Inspect_z155) => (__$a__ => `{ ` + `hasJS: ` + Inspect_z155.inspect()(__$a__.hasJS) + `, ` + `hasLLVM: ` + Inspect_g162.inspect()(__$a__.hasLLVM) + `, ` + `isAvailable: ` + Inspect_n169.inspect()(__$a__.isAvailable) + ` }`);
  ...
  Inspect['Record_hasJSf_08e01963e32f303d010c30bf965841bdf_hasLLVMf_18e01963e32f303d010c30bf965841bdf_isAvailablef_28e01963e32f303d010c30bf965841bdf']['inspect'] = () => (Inspect_d211) => (Inspect_w204) => (Inspect_p197) => (__$a__ => `{ ` + `hasJS: ` + Inspect_p197.inspect()(__$a__.hasJS) + `, ` + `hasLLVM: ` + Inspect_w204.inspect()(__$a__.hasLLVM) + `, ` + `isAvailable: ` + Inspect_d211.inspect()(__$a__.isAvailable) + ` }`);
  ...
  let DocApp = (state => {
      ...
      return div(({ v: className(`documentation`), n: null }))(({ v: Header(state.target), n: { v: SideMenu(state.search)(state.modules), n: { v: main$1(({ v: className(`documentation__content`), n: null }))(({ v: Breadcrumbs(state), n: { v: ContentView(state.target)(pathResult), n: null } })), n: null } } }));
  });
