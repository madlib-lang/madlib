...
spec = do
  let cases =
        ...
        , "compiler/test/Blackbox/test-cases/jsx-open-spread"
        , "compiler/test/Blackbox/test-cases/typechecker-audit"
        , "compiler/test/Blackbox/test-cases/alias-row-overlay"
        , "compiler/test/Blackbox/test-cases/typeof-open-record-overlay"
        , "compiler/test/Blackbox/test-cases/instance-repeated-variable-dispatch"
        ...
        , "compiler/test/Blackbox/test-cases/js-reserved-binding-name"
