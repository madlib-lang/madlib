...
define external fastcc  i8* @__edc209afd0927a85d7d119088a377001__ch(i8*  %count_0, i8*  %acc_0)    {
; <label>:0:
...
truthyBlock_0:
  %ptr = call ccc  i8*  @GC_malloc(i64  ptrtoint ({i8*, i8*}** getelementptr inbounds ({i8*, i8*}*, {i8*, i8*}** inttoptr (i32 0 to {i8*, i8*}**), i32 1) to i64))  
  %casted = bitcast i8* %ptr to {i8*, i8*}**
  store {i8*, i8*}* %4, {i8*, i8*}** %casted, align 8
  %boxed = bitcast {i8*, i8*}** %casted to i8*
...
falsyBlock_0:
  ...
  ; %20 = add i8  1, 1;%20 =  call ccc  i8*  @GC_malloc(i64  ptrtoint ({i8*, i8*}** getelementptr inbounds ({i8*, i8*}*, {i8*, i8*}** inttoptr (i32 0 to {i8*, i8*}**), i32 1) to i64))  
  ; %21 = add i8 1, 1;%21 = bitcast i8* %20 to {i8*, i8*}** 
  ;store  {i8*, i8*}* %16, {i8*, i8*}** %21, align 8 
  ; %22 = add i8 1, 1 ;bitcast {i8*, i8*}** %21 to i8* 
  ; %23 =  tail call fastcc  i8*  @__edc209afd0927a85d7d119088a377001__ch(i8*  %19, i8*  %14)  
  ...
  %23 =  tail call fastcc  i8*  @__edc209afd0927a85d7d119088a377001__ch(i8*  %19, i8*  %22)  
  %24 = add i8  1, 1;bitcast i8* %23 to {i8*, i8*}** 
  %25 = add i8  1, 1;load  {i8*, i8*}*, {i8*, i8*}** %24, align 8 
  br label %condBlock_0 
condBlock_0:
  %26 = phi i8* [%boxed, %truthyBlock_0], [%23, %falsyBlock_0] 
...
define external ccc  i8* @__edc209afd0927a85d7d119088a377001__createBigList(i8*  %count_0)    {
  ...
  %11 =  tail call fastcc  i8*  @__edc209afd0927a85d7d119088a377001__ch(i8*  %7, i8*  %10)  
  %12 = bitcast i8* %11 to {i8*, i8*}** 
