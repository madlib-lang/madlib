...
import { key, link, to, className, li, text, ul } from "./../../../MadUI/src/Main.mjs";
import { append, intercalateWithIndex, reduce } from "./../../../../.prelude/List.mjs";
...
export let Breadcrumbs = (_P_ => (breadcrumbs => ul(({ v: className(`breadcrumbs`), n: null }))((breadcrumbs)))(intercalateWithIndex((i => li(({ v: className(`breadcrumbs__separator`), n: { v: key(`sep-` + Show.Integer_5b7ebeeaa5acfe1eeea5a9e9845b152d.show()(i)), n: null } }))(({ v: `/`, n: null }))))(Functor.List_5b7ebeeaa5acfe1eeea5a9e9845b152d.map()(BreadcrumbItem)(computeBreadcrumbs(_P_)))));
