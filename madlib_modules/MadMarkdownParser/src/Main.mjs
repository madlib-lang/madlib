...
let text = (_P_ => Functor.Parser_a91f6bfcb96b14c62290a677a2570798.map()((_P_ => Text(String.fromList(_P_))))((__$PH13__ => P.someTill(__$PH13__)(P.lookAhead(textTerminals)))(_P_)))(P.notChar(__String.fromCharCode(10)));
...
let contentWithLineReturn = (delimiter => (_P_ => Functor.Parser_a91f6bfcb96b14c62290a677a2570798.map()(dropWhile(equals(LineReturn)))(P.some(P.choice(_P_))))(({ v: bold, n: { v: italic, n: { v: inlineCode, n: { v: image, n: { v: link, n: { v: text, n: { v: lineReturnExceptBefore(delimiter), n: null } } } } } } })));
