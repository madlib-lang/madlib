...
import { _10be0_show__5 } from "./__BUILTINS__.mjs";
...
export function _df1ab_log__4(__P__2) {
  return (__P__2 => _df1ab_putLine__1(_10be0_show__5(__P__2)))(__P__2);
}
export function __moduleInit_df1ab() {}


export default {_df1ab_putLine__1,_df1ab_log__4};